                            ...
                            <div class="row justify-content-center align-items-center text-center" style="margin-left:-30%; margin-top:10%">
                                ...
                                <h1 data-aos="fade-up" style="margin-left: 3%;" data-aos-delay="100" name="dados">
                                    <?php
                                        ...
                                        $usuario = $banco->getData("SELECT * FROM fotografo WHERE fotografo_id = '1'");
                                        echo $usuario[0]['nome'] . "<br>" . "<br>";
                                        echo "<br>". "<h1>" . $usuario[0]['tipo'] . "</h1>";
                                        ?>
                                </h1>
                                <a href="index-perfil-edt.html" style="margin-left: 25px; color: #50c058;">Editar
                                    Perfil</a>
                            </div>
                        </div>
                    </div>
