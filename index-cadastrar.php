                        ...
                        <div class="col-12">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                                    <form action="usuario.php" method="post" class="form-box">
                                        <h3 class="h4 text-black mb-4">Cadastrar</h3>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control"  name ="cpf" name="cpf" placeholder="Cpf">
                                        </div>
                                        <div class="form-group">
